Contributing to AMP Core
============================

The AMP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AMP Core project, and is not to be
confused with overall AMP Network Protocol consensus changes.

Whether a pull request is merged into AMP Core rests with the project merge
...
Patches that change AMP consensus rules are considerably more involved than
...
Where a patch set proposes to change the AMP consensus, it must have been
...
The project leader is the release manager for each AMP Core release.
