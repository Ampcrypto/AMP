...
RESOURCES += src/qt/amp.qrc src/qt/amp_locale.qrc

TRANSLATIONS += src/qt/locale/amp_bg.ts \
                src/qt/locale/amp_de.ts \
                src/qt/locale/amp_en.ts \
                src/qt/locale/amp_es.ts \
                src/qt/locale/amp_fi.ts \
                src/qt/locale/amp_fr.ts \
                src/qt/locale/amp_it.ts \
                src/qt/locale/amp_ja.ts \
                src/qt/locale/amp_pl.ts \
                src/qt/locale/amp_pt.ts \
                src/qt/locale/amp_ru.ts \
                src/qt/locale/amp_sk.ts \
                src/qt/locale/amp_sv.ts \
                src/qt/locale/amp_vi.ts \
                src/qt/locale/amp_zh_CN.ts \
                src/qt/locale/amp_zh_TW.ts
