...
This means one can have an always-on ampd instance running, and another local ampd/amp-qt instance which connects to this node and receives blocks from it.
