...
In order to support loading of multiple wallets in amp-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is amp.cpp.
...
Changes to amp.cpp
----------------------
amp.cpp is the entry point into amp-qt, and as such, will require some minor modifications to provide hooks for
