AMP Core version 2.2.1 is now available from:

  <https://github.com/amp-project/amp/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/amp-project/amp/issues>

Compatibility
==============

AMP Core is extensively tested on multiple operating systems using
...
AMP Core should also work on most other Unix-like systems but is not
...
of Bitcoin that AMP was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/amp-project-translations/).
