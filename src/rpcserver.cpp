...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AMP features */
        {"amp", "masternode", &masternode, true, true, false},
        {"amp", "masternodelist", &masternodelist, true, true, false},
        {"amp", "mnbudget", &mnbudget, true, true, false},
        {"amp", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"amp", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"amp", "mnsync", &mnsync, true, true, false},
        {"amp", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"amp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ampd, or the -server option to amp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> amp-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41506/\n";
}
