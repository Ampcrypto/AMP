                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AMP Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AMP address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and amp: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AMP Core"), this);
    aboutAction->setStatusTip(tr("Show information about AMP Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AMP"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AMP addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AMP addresses"));
    ...
    openAction->setStatusTip(tr("Open a AMP: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AMP Core help message to get a list with possible AMP command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AMP Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AMP network", "", count));
}
...
{
    QString strTitle = tr("AMP Core"); // default title
